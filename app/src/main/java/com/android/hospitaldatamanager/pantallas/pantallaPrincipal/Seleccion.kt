...
@Composable
fun Seleccion(navigationController: NavHostController) {
    TopAppBar(
        { },
        navigationIcon = {
            IconButton(onClick = {}) {
    ...
    Column(Modifier.fillMaxSize()) {
        ...
        Box(modifier = Modifier.align(alignment = Alignment.CenterHorizontally)){
            Text(text = "¿ Eres ?", fontSize = 26.sp, fontWeight = FontWeight.ExtraBold  )
        }

        Spacer(modifier = Modifier.height(40.dp))

        Button(
            onClick = { navigationController.navigate("RegistroPacientes") },
            modifier = Modifier
                .align(alignment = Alignment.CenterHorizontally)
                .width(300.dp)
                .height(50.dp),
        ...
        Button(
            onClick = { navigationController.navigate("RegistroDoctores")},
            modifier = Modifier
                .align(alignment = Alignment.CenterHorizontally)
                .width(300.dp)
                .height(50.dp),
